...
function CallToAction() {
  return (
    <div className="text-center flex flex-col gap-7 px-7 py-14 bg-gray-800">
      ...
      <Link
        href="/signup"
        className="bg-white text-gray-800 font-bold text-xl w-full py-2 rounded-md tracking-wider text-center md:w-52 mx-auto"
      >
        Sign Up Now
      </Link>
    </div>
