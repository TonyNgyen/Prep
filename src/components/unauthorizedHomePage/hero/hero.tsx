...
function Hero() {
  return (
    <div className="bg-gray-800 flex items-center justify-center px-5 py-10 flex-col gap-5">
      ...
      <Link
        href="/signup"
        className="bg-white text-gray-800 font-bold text-xl w-full py-2 rounded-md tracking-wider text-center md:w-52"
      >
        Get Started
      </Link>
    </div>
